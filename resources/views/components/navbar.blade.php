  ...
  <nav class="dark:bg-gray-900 fixed w-full z-20 top-0 start-0 dark:border-gray-600 mt-2">
    <div class="max-w-[80%] flex flex-wrap items-center justify-between mx-auto p-4 transition ease-in delay-150 rounded-xl" id="navbar-id">
        ...
        <div class="items- center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul id="desktop" class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                    ...
                    <div id="dropdownNavbar" class="w-[250px] z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm font-medium text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
            ...
            <ul id="mobile" class="bg-[#142792] flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                  <x-navlink href="/" :active="request()->is('/')">Home</x-navlink>
              </li>
              <li>
                  ...
                  <button id="dropdownDelayButton" data-dropdown-toggle="dropdownDelay" data-dropdown-delay="500" data-dropdown-trigger="hover" class="flex items-center justify-between w-full py-2 px-3 text-white rounded hover:bg-[#1a56db] md:hover:bg-transparent md:border-0 md:hover:text-[#fffc14] md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-[#1a56db] dark:hover:bg-[#1a56db] md:dark:hover:bg-transparent" type="button">Product <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    </svg>
                    </button>
