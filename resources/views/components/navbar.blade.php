  ...
  <nav class="dark:bg-gray-900 fixed w-full z-20 top-0 start-0 dark:border-gray-600 mt-2">
    <div class="max-w-[65%] flex flex-wrap items-center justify-between mx-auto p-4 transition ease-in delay-150 rounded-xl" id="navbar-id">
...
<script>
  window.addEventListener("scroll", function(){
    ...
    nav.classList.toggle("bg-[#384fd4]", window.scrollY > 0);
  })
</script>