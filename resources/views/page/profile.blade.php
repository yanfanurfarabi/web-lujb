<x-layout>
    ...
    {{-- section 3 visi misi --}}
    <section class="bg-white dark:bg-gray-900" style="background-image: url('{{ asset('storage/img/'. $images[5]->image) }}')" id="desktop">
        <div class="max-w-screen-xl mx-auto p-4">
            <div class="grid grid-cols-2 gap-20 justify-items-center mb-16 mt-10">
                <div class="justify-items-center">
                    <img src="{{ asset('storage/img/'. $images[3]->image) }}" class="w-auto h-20 mb-5" alt="vission icon" />
                ...
                <div class="justify-items-center">
                    <img src="{{ asset('storage/img/'. $images[4]->image) }}" class="w-auto h-20 mb-5" alt="mission icon" />
    ...
    <section class="bg-white dark:bg-gray-900" id="desktop">
        <div class="max-w-screen-xl mx-auto p-4">
            <div class="grid grid-cols-2 gap-10 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div>
                    <img class="w-96 rounded-md" src="{{ asset('storage/img/'. $images[2]->image) }}" alt="office content 1">
                </div>
    ...
    <section class="bg-white dark:bg-gray-900" id="mobile">
        <div class="max-w-screen-xl mx-auto p-4">
            <div class="gap-10 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div>
                    <img class="w-full rounded-md" src="{{ asset('storage/img/'. $images[2]->image) }}" alt="office content 1">
                </div>
                    <div class="font-regular text-gray-500 sm:text-lg dark:text-gray-400">
